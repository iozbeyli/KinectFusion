...
{
public:
	bool apply(TsdfVolume& volume, GlobalModel& model, Eigen::Matrix4f frameCameraToWorld)
	{
		if (!model.reset())
		{
		...
		applyRaycaster_v3<<<threads, blocks>>>(
				model.colorMapGPU,
				gpuMatrix,
				volume.sdf,
				volume.weights,
