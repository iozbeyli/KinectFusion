...
public:
	...
	VirtualSensor(int increment = 10) : m_currentIdx(-1), m_increment(increment)
	{
	...
	size_t GetDepthImageSize()
	{
		return GetDepthImageHeight() * GetDepthImageWidth() * sizeof(float);
	}
